                        ...
                        <table class="min-w-full divide-y divide-gray-200 border border-gray-300 rounded-lg overflow-hidden">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="w-1/10 px-6 py-4 text-left text-sm font-semibold text-gray-600">Amount (RM)</th> 
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-300">
                                    ...
                                    <td class="w-1/10 px-6 py-4 text-left text-sm text-gray-600">{{ number_format($inventory->amount, 2) }}</td>
