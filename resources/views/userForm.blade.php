                    ...
                    <form method="POST" action="{{ route('userForm.store') }}">
                        ...
                        <div x-data="{ show: false }" 
                            ...
                            <div class="flex items-center gap-2 mb-4">
                                ...
                                <p class="text-sm text-gray-600 mt-1">You can only create users in your department: {{ auth()->user()->department->name ?? 'your department' }}</p>
                                @endif
                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select name="department_id" id="department_id" class="pl-10 w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300 {{ auth()->user()->role === 'HOD' && !$hasFullAccess ? 'bg-gray-100' : '' }}" {{ auth()->user()->role === 'HOD' && !$hasFullAccess ? 'disabled' : '' }} required>
                                            ...
                                            @foreach ($departments as $department)
                                                <option value="{{ $department->id }}" {{ auth()->user()->role === 'HOD' && !$hasFullAccess && auth()->user()->department_id == $department->id ? 'selected' : '' }}>{{ $department->name }}</option>
                                            @endforeach
                                        </select>
                                        @if(auth()->user()->role === 'HOD' && !$hasFullAccess)
                                 ...
                                 <div>
                                     ...
                                     <div class="relative">
                                         ...
                                         <select name="role" id="role" class="pl-10 w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300" required>
